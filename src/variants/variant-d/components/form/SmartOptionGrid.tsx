      ...
      {options.map((option) => {
        ...
        return (
          ...
          >
            ...
            {/* Highlight badge (e.g., "Full points on tax") */}
            {option.highlight && !selected && !option.popular && (
              <span className="absolute -top-2 left-4 px-2 py-0.5 bg-[#22C55E] text-white text-[10px] font-bold rounded-full">
                {option.highlight}
              </span>
            )}
