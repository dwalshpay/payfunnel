export interface VariantBAStepOption {
  id: string;
  label: string;
  icon?: string;
...
export interface VariantBAStepConfig {
  id: string;
  title: string;
  subtitle?: string;
...
export const VARIANT_BA_STEPS: VariantBAStepConfig[] = [
...
export const VARIANT_BA_TOTAL_STEPS = VARIANT_BA_STEPS.length; // Now 8 steps

export const VARIANT_BA_TESTIMONIALS = [
  {
    name: 'Sarah M.',
    role: 'Business Owner',
