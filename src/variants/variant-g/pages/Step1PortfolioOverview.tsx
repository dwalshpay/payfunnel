...
import { ClientCountSelector } from '../components/form/ClientCountSelector';
import { ExpenseRangeSelector } from '../components/form/ExpenseRangeSelector';

export function Step1PortfolioOverview() {
      ...
      <div className="p-6 md:p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#6B7280] mt-2">
            We'll calculate the potential rewards across all your clients
          </p>
        </div>
