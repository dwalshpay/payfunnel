...
export function VerificationCodePage() {
  const { state, setRegistrationField, completeFunnel, prevStep, canProceed } = useVariantC();
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-[#22C55E] to-[#16A34A] flex items-center justify-center shadow-lg shadow-[#22C55E]/20">
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-[#F0F7FF] to-[#E8F4FF] rounded-xl p-4 border border-[#E2E9F9]">
        ...
        <div className="relative flex items-center justify-between">
          <div>
            <p className="text-xs text-[#6B7280] font-medium uppercase tracking-wide">Your rewards</p>
            <p className="text-xl font-bold text-[#3866B0]">{rewards.formattedPoints}</p>
          </div>
          <div className="text-right">
            <p className="text-xs text-[#22C55E] font-medium">One step away</p>
            <p className="text-[13px] text-[#6B7280]">from your dashboard</p>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <label className="block text-[14px] font-semibold text-[#283E48] text-center">
            ...
            <input
              ...
              className={`
                ...
                ${digit
                  ...
                  : 'border-[#E2E9F9] text-[#9CA3AF]'}
                focus:outline-none focus:border-[#3866B0] focus:shadow-[0_0_0_4px_rgba(56,102,176,0.1)]
              `}
              autoFocus={index === 0}
            />
          ))}
      ...
      <div className="text-center space-y-2">
        {resendTimer > 0 ? (
          ...
          <button
            ...
            className="text-[13px] font-semibold text-[#3866B0] hover:text-[#2D5490] transition-colors disabled:opacity-50"
          >
      ...
      <div className="text-center">
        <button
          onClick={prevStep}
          className="text-[13px] text-[#6B7280] hover:text-[#3866B0] transition-colors underline-offset-2 hover:underline"
        >
          Change phone number
        </button>
      </div>
